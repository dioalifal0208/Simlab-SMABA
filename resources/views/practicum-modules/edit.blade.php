                    ...
                    <form action="{{ route('practicum-modules.update', $module->id) }}" method="POST">
                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                ...
                                <input type="text" name="title" id="title" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-smaba-dark-blue focus:ring-smaba-dark-blue" value="{{ old('title', $module->title) }}" required autofocus>
                            </div>

                            {{-- Deskripsi / Langkah-langkah --}}
                            <div>
                                <label for="description" class="block font-medium text-sm text-gray-700">Deskripsi / Langkah-langkah (Opsional)</label>
                                <textarea name="description" id="description" rows="5" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-smaba-dark-blue focus:ring-smaba-dark-blue" placeholder="Tuliskan langkah-langkah praktikum atau SOP di sini...">{{ old('description', $module->description) }}</textarea>
                            </div>
