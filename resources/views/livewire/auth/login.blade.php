<div class="w-full max-w-md bg-white p-8 rounded-xl shadow-lg" data-aos="fade-left">
    ...
    <form wire:submit="login" class="space-y-4">
        <div>
            ...
            <input wire:model.live.debounce.500ms="email" id="email" class="block mt-1 w-full rounded-md border-gray-300 shadow-sm focus:border-smaba-dark-blue focus:ring-smaba-dark-blue" type="email" required autofocus />
        </div>
