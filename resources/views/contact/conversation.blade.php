        ...
        <div class="max-w-5xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="bg-white border border-gray-100 shadow-sm sm:rounded-xl">
                <div class="p-5 border-b border-gray-100 flex items-center justify-between">
                    <div>
                        <p class="text-sm font-semibold text-gray-900">Admin Lab</p>
                        <p class="text-xs text-gray-500">Balasan akan tampil di bawah.</p>
                    </div>
                ...
                <div class="p-5 space-y-4 max-h-[60vh] overflow-y-auto">
                    ...
                    @empty
                        <p class="text-sm text-gray-600">Belum ada pesan. Mulai percakapan di bawah.</p>
                    @endforelse
                </div>

                <div class="p-5 border-t border-gray-100">
                    <form action="{{ route('contact.conversations.store') }}" method="POST" class="space-y-3">
                        @csrf
                        <div>
