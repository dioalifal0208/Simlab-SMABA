        ...
        <input 
            ...
            {{ $attributes->merge([
                ...
                ($hasError 
                    ...
                    : 'border-slate-200 text-slate-900 placeholder-slate-400 focus:border-indigo-500 focus:ring-4 focus:ring-indigo-500/20 bg-slate-50 hover:bg-white focus:bg-white')
            ]) }}
        />
