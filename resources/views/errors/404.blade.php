<x-app-layout :hide-chrome="true">
    <div class="w-full max-w-xl mx-auto flex items-center justify-center py-16 px-4">
        <div class="w-full text-center" data-aos="fade-up" data-aos-duration="700">
            {{-- Badge status --}}
            <div class="inline-flex items-center justify-center rounded-full bg-indigo-600/5 text-indigo-600 mb-6 px-3 py-1 text-xs font-semibold">
                <span class="mr-2 flex h-6 w-6 items-center justify-center rounded-full bg-indigo-600 text-white">
            ...
            <h1 class="text-5xl sm:text-6xl font-extrabold text-gray-900 tracking-tight">
                4<span class="text-indigo-600">0</span>4
            </h1>
            ...
            <div class="mt-8 flex flex-col sm:flex-row items-center justify-center gap-3">
                <a href="{{ route('dashboard') }}" class="inline-flex items-center px-5 py-2.5 rounded-lg bg-indigo-600 text-white text-sm font-semibold shadow-sm hover:bg-indigo-500 transition-colors">
