<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <div>
                <h2 class="font-bold text-2xl text-smaba-text leading-tight">{{ __('items.requests.title') }}</h2>
            ...
            <div class="bg-white shadow-sm sm:rounded-xl border border-gray-100">
                <div class="p-6 space-y-6">
                    <div class="bg-smaba-dark-blue/5 border border-smaba-dark-blue/10 text-sm text-gray-700 p-4 rounded-lg">
                        <p class="font-semibold text-smaba-dark-blue">{{ __('items.requests.note_title') }}</p>
