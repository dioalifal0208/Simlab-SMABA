<x-app-layout>
    <x-slot name="header">
        ...
        <div>
            ...
            <p class="text-sm text-gray-500 mt-1">Isi detail untuk menambahkan alat atau bahan baru ke dalam inventaris.</p>
        </div>
    </x-slot>
                    ...
                    <form action="{{ route('items.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="md:col-span-2">
                                ...
                                <input id="nama_alat" class="block mt-1 w-full rounded-md border-gray-300 shadow-sm focus:border-smaba-dark-blue focus:ring-smaba-dark-blue" type="text" name="nama_alat" value="{{ old('nama_alat') }}" required autofocus />
                            </div>
                            ...
                            <div class="md:col-span-2">
                                ...
                                <select name="tipe" id="tipe" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-smaba-dark-blue focus:ring-smaba-dark-blue">
                                    <option value="Alat" @selected(old('tipe', 'Alat') == 'Alat')>Alat (Tidak Habis Pakai)</option>
                                    <option value="Bahan Habis Pakai" @selected(old('tipe') == 'Bahan Habis Pakai')>Bahan Habis Pakai (Consumable)</option>
                                </select>
                            </div>
                            ...
                            <div class="md:col-span-2 grid grid-cols-1 md:grid-cols-3 gap-6">
                                <div>
                                    ...
                                    <input type="number" name="jumlah" id="jumlah" value="{{ old('jumlah') }}" required class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-smaba-dark-blue focus:ring-smaba-dark-blue">
                                </div>
                                <div>
                                    ...
                                    <input type="number" name="stok_minimum" id="stok_minimum" value="{{ old('stok_minimum') }}" placeholder="Contoh: 10" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-smaba-dark-blue focus:ring-smaba-dark-blue">
                                </div>
                                <div>
                                    <label for="satuan" class="block text-sm font-medium text-gray-700">Satuan</label>
                                    <input type="text" name="satuan" id="satuan" value="{{ old('satuan') }}" placeholder="Contoh: Pcs, Gram, Liter" required class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-smaba-dark-blue focus:ring-smaba-dark-blue">
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <select name="kondisi" id="kondisi" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-smaba-dark-blue focus:ring-smaba-dark-blue" required>
                                    ...
                                    <option value="Kurang Baik" @selected(old('kondisi') == 'Kurang Baik')>Kurang Baik</option>
                            ...
                            <div class="md:col-span-2">
                                ...
                                <textarea name="deskripsi" id="deskripsi" rows="3" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-smaba-dark-blue focus:ring-smaba-dark-blue">{{ old('deskripsi') }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="mt-8 flex justify-end space-x-3">
                            ...
                            <button type="submit" class="px-6 py-2 bg-smaba-dark-blue text-white rounded-md hover:bg-smaba-light-blue font-semibold text-sm shadow-md transition-colors">Simpan Item</button>
                        </div>
                    </form>
                </div>
            </div>
